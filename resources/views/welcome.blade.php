        	...
        	<div class="home-slideshow">
            	<div class="slide">
                	<div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="{{ asset('images/logo/library1.jpg') }}" src="{{ asset('images/logo/library1.jpg') }}" alt="landing img" title="landing img" />
                ...
                <div class="slide">
                	<div class="blur-up lazyload bg-size">
                        <img class="blur-up lazyload bg-img" data-src="{{ asset('images/logo/library2.jpg') }}" src="{{ asset('images/logo/library2.jpg') }}" alt="landing img" title="landing img" />
                        <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                            <div class="slideshow__text-content bottom">
                                <div class="wrap-caption center">
