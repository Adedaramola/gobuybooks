        ...
        <div class="container">
            ...
            <div class="footer-top">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-3 contact-box">
                        <h4 class="h4">Contact Us</h4>
                        <ul class="addressFooter">
                            <li><i class="icon anm anm-map-marker-al"></i><p>NO.6, Owuye street, NNPC,<br>Ibadan .Nigeria</p></li>
                            <li class="phone"><i class="icon anm anm-phone-s"></i><p>080 6973 5321</p></li>
                            <li class="email"><i class="icon anm anm-envelope-l"></i><p>gobuybooks@gmail.com</p></li>
                        </ul>
                    </div>
                </div>
            </div>
