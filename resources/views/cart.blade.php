...
<div class="pageWrapper">
                ...
                <div class="col-12 col-sm-12 col-md-8 col-lg-8 main-col">
                    <form class="cart style2">
                        <table>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="3" class="text-left"><a href="/shop" class="btn--link cart-continue"><i
                        ...
                        <div class="currencymsg">We processes all orders in NGN. While the content of your cart is
                            currently displayed in NGN, the checkout will use NGN at the most current exchange rate.
                        </div>
                        <hr>
                    ...
                    <div class="solid-border">
                        <div class="row">
                            ...
                            <span class="col-12 col-sm-6 cart__subtotal-title cart__subtotal text-right"><span
                                    class="money" id="total_checkout">0</span></span>
                        </div>
    ...
    function editTotal(id, price) {
        alert('heellp');
        document.querySelector(`#totTab${id}`).innerHTML = (parseInt(document.querySelector(`#qty${id}`).value) * price)
            .toLocaleString();
    }
    </script>
